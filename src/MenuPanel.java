...
public class MenuPanel extends JPanel
{
    ...
    private void isRuleSelected(ArrayList<Rule> rules, JCheckBox rule3Disable, JComboBox<String> rule3Direction, JComboBox<Integer> rule3State, JComboBox<Integer> rule3CellValue, JComboBox<Integer> rule3NewCellValue, JComboBox<Integer> rule3NewState)
    {
        String firstChar;
        if(!rule3Disable.isSelected())
        {
            firstChar = ((String) rule3Direction.getSelectedItem()).substring(0,1);
            Rule rule3 = new Rule((Integer) rule3State.getSelectedItem(), (Integer) rule3CellValue.getSelectedItem(), Rule.returnDirection(firstChar), (Integer) rule3NewCellValue.getSelectedItem(), (Integer) rule3NewState.getSelectedItem());
            rules.add(rule3);
        }
    }
}
